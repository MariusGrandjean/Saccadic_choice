...
mean_face_hori_coef <- brm.coefs[1] + brm.coefs[2]*0 + brm.coefs[3]*0 # 211

mean_vehicle_hori_coef <- brm.coefs[1] + brm.coefs[2]*1 + brm.coefs[3]*0 # 222: 211 (face when hori/baseline) + 11.3 (vehicles when hori)

mean_face_vert_coef <- brm.coefs[1] + brm.coefs[2]*0 + brm.coefs[3]*1 # 216 : 211 (face when hori) + 5.89 (vertical meridian)

mean_vehicle_vert_coef <- brm.coefs[1] + brm.coefs[2]*1 + brm.coefs[3]*1 # 227 : 211 (faces when hori) + 11.3 (vehicles when hori) + 5.89 (vertical meridian)


# We look the summary of the model
summary(brm1)

hypothesis(brm1, "TargetVehicles:meridianVertical > 0") # for the interaction 
...
hdi(main_effects_samples, ci = 0.89)
...
hdi_diff_meridian <- hdi(prob_diff_meridian, ci = 0.89)

# Summarize results for Targets
mean_diff_targets <- mean(prob_diff_targets)
hdi_diff_targets <- hdi(prob_diff_targets, ci = 0.89)
