...
# As we find no interaction, we only create HDI for the significant effects
...
# As we find no interaction, we only create HDI for the significant effects
compare_groups(fit = brm_acc_1,
               lower = Target == "Vehicles" ,
               higher = Target =="Faces",
               hdi = 0.89,
               include_bf = FALSE)

compare_groups(fit = brm_acc_1,
               lower = meridian == "Vertical" ,
               higher = meridian =="Horizontal",
               hdi = 0.89,
               include_bf = FALSE)
